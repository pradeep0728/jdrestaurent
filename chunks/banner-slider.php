<section class="fslider">
		<div class="slider">
		    ...
		    <li>
		        ...
		        <h3 style="font-size: 3rem !important; font-style: bold !important; font-family: 'Bree Serif', serif; color:#FCFCFC;">JD's Restaurent - The Quality Food!</h3>  
		        <h5 class="light black-text text-lighten-3"><strong style="color:#FCFCFC";>We deliver Quality. Try us and then buy us!</strong></h5>  
		      </div>  
		    </li>
